...
title: Let's Get Out The Vote
excerpt: Help elect candidates, forming local teams now!
image: '/src/assets/images/2024/the-original-iwo-jima.jpg'
category: Events
location: Online via Zoom
eventDate: 8/22/2024 7PM
tags:
  - volunteers
  - zoomcall
metadata:
  canonical: https://agrpac.vercel.app/gotv
---

import DListItem from '~/components/ui/DListItem.astro';
import ToggleTheme from '~/components/common/ToggleTheme.astro';

<span class="text-sm block pb-12">Caption: Iwo Jima Monument, Harlingen, TX Photo credit: Gold Country Cowgirl</span>
